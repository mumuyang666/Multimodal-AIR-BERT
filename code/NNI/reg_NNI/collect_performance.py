...
if __name__ == "__main__":
    key_list = ["GLCTLVAML","IVTDFSVIK" , "AVFDRKSDAK", "GILGFVFTL", "KLGGALQAK", "RAKFKQLL", "ELAGIGILTV" ]
    for key in key_list:
        input_folder = f'/aceph/louisyuzhao/buddy2/linyangxiao/SC-AIR/SC-AIR-BERT-Multi/result_NNI/reg_new/{key}/{key}'
        output_file = f'/aceph/louisyuzhao/buddy2/linyangxiao/SC-AIR/SC-AIR-BERT-Multi/result_NNI/reg_new/{key}/{key}_performance.csv'
