...
# declare an array
arr=("GLCTLVAML" "IVTDFSVIK" "AVFDRKSDAK" "GILGFVFTL" "KLGGALQAK" "RAKFKQLL" "ELAGIGILTV" "eos" )

# for loop that iterates over each element in arr
for i in "${arr[@]}"
do  
    python3 /aceph/louisyuzhao/buddy2/linyangxiao/SC-AIR/SC-AIR-BERT-Multi/code/classification/train_reg.py \
...
-o /aceph/louisyuzhao/buddy2/linyangxiao/SC-AIR/SC-AIR-BERT-Multi/result_NNI/reg_new/$i \
--lr_b 0.0001 \
--lr_c 0.001 \
--seq_len  79 \
--prob 0.0 \
